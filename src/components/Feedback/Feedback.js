      ...
      <div className="container mt-2 w-75n/ ">
          ...
          <p>
            <button type="button" className="btn btn-light intcolor1">
              <i className='bi bi-emoji-heart-eyes' style={{fontSize: '40px', color: 'green'}}></i><br />
              Love it
            </button>
            <button type="button" className="btn btn-light intcolor2">
              <i className='bi bi-emoji-smile' style={{fontSize: '40px', color: 'rgb(38, 180, 216)'}}></i>
              <br />
              Good
            </button>
            <button type="button" className="btn btn-light intcolor3">
              <i className='bi bi-emoji-neutral' style={{fontSize: '40px', color: 'rgb(173, 35, 162)'}}></i>
              <br />
              Average
            </button>
            <button type="button" className="btn btn-light intcolor4">
              <i className='bi bi-emoji-frown' style={{fontSize: '40px', color: 'rgb(214, 211, 48)'}}></i>
              <br />
              Poor
            </button>
            <button type="button" className="btn btn-light intcolor5">
              <i className="bi bi-emoji-angry" style={{fontSize: '40px', color: 'rgba(248, 24, 24, 0.836)'}}></i>
              <br />
              Disgusting
            </button>
          </p>
