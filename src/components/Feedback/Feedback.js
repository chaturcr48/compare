    ...
    return (
        <><div>
            <div className="center">
                <h3><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-chat-right"
                    viewBox="0 0 16 16">
                    <path
                        d="M2 1a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h9.586a2 2 0 0 1 1.414.586l2 2V2a1 1 0 0 0-1-1H2zm12-1a2 2 0 0 1 2 2v12.793a.5.5 0 0 1-.854.353l-2.853-2.853a1 1 0 0 0-.707-.293H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12z" />
                </svg>&nbsp;we'd love your feedback</h3>
                <p>We let our users send our suggestions and idea about web page.We welcome problems,reports,features,ideas and
                    general comments.We will be delighted to hear from you
                </p><br />
                <p>
                ...
                <p>
                    ...
                    <button type="button" className="btn btn-light intcolor5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                            className="bi bi-emoji-angry" viewBox="0 0 16 16">
                            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"></path>
                            <path
                ...
                <input className="btn btn-success float" type="submit" value="Submit" />
