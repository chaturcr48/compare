        ...
        <React.Fragment>
            <nav className="navbar navbar-expand-lg navbar-light">
                <div className="container-fluid ">
                    ...
                    <div className="collapse navbar-collapse " id="navbarSupportedContent" style="padding-left: 12vw;">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        <li className="nav-link  fs-3 px-5">
                        <a className="nav-link active" aria-current="page" href="#"><u>Team</u> </a>
                        </li>
                        <li className="nav-link  fs-3 px-5">
                ...
                <hr style="margin: 0% 4%;width: 92%;">

                <div className="container my-4">
                    <div className="my-5 pb-3 row featurette d-flex justify-content-center align-items-center">
                        <div className="col-md-3 order-md-1">
                            <img className="img-fluid" src="https://source.unsplash.com/200x200/?laptop" alt="..."
                                style="border-radius: 50%;">
                        </div>
                        <div className="col-md-8 order-md-2 my-3">
                            <h3 className="featurette-heading">Afham Fardeen
                            </h3>
                            <span className="fs-6" style="color: rgb(255, 135, 16);">HR</span>
                            <p className="fs-6">Some great placeholder content for the first featurette here. Imagine some exciting
                                prose here.Some great placeholder content for the first featurette here. Imagine some exciting
                                prose here.Some great placeholder content for the first featurette here. Imagine some exciting
                                prose here.
                            </p>
                        </div>
                    ...
                    <div className="my-5 py-3 row featurette d-flex justify-content-center align-items-center">
                        <div className="col-md-8">
                            <h3 className="featurette-heading">Kumar Chatur Ranjan
                            </h3>
                            <span className="fs-6" style="color: rgb(255, 135, 16);">Engineer</span>
                            <p className="fs-6">Some great placeholder content for the first featurette here. Imagine some exciting
                                prose here.Some great placeholder content for the first featurette here. Imagine some exciting
                                prose here.Some great placeholder content for the first featurette here. Imagine some exciting
                                prose here.
                    ...
                    <div className="mt-5 pt-3 row featurette d-flex justify-content-center align-items-center">
                        ...
                        <div className="col-md-8 order-md-2">
                            <h3 className="featurette-heading">Himanshu Kumar
                            </h3>
                            <span className="fs-6"  style="color: rgb(255, 135, 16);">HR</span>
                            <p className="fs-6">Some great placeholder content for the first featurette here. Imagine some exciting
                                prose here.Some great placeholder content for the first featurette here. Imagine some exciting
...
>>>>>>> cf1c7f72145974b43ef686ebf4dd5510e51466b6
export default Team;
