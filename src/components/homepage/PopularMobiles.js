...
let imgUrl_amazon = 'https://www.amazon.in/dp/B089MS8XQ3/ref=s9_acsd_al_bw_c2_x_1_i?pf_rd_m=A1K21FY43GMZF8&pf_rd_s=merchandised-search-4&pf_rd_r=YT17BG8KJ2RJ0C7HK1J9&pf_rd_t=101&pf_rd_p=0d9bd1b8-0a59-4839-a3f9-38a902ab3e28&pf_rd_i=21634722031';
const items = [
  {
    id: "1",
    imgUrl:
    ...
    <React.Fragment>
      ...
      <div className="container">
        <div class="card" style={{ width: "12rem" }}>
          ...
          />
          <div class="card-body">
            <h5 class="card-title">Realme 4s</h5>
            <p class="card-text">(4GB + 64Gb)</p>
          </div>
