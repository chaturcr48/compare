  ...
  return (
    <React.Fragment>
      <div className="container mt-2">
        ...
        <div className="row">
          <div className="col">
            <div className=" fs-4 my-1">Processor And Memory Features</div>
            <table className="table" style={{ width: "75vw" }}>
              <tbody>
                <tr>
        ...
        <div className="row">
          <div className=" fs-4 my-1">Display And Audio Features</div>
          <div className="col">
            <table className="table" style={{ width: "75vw" }}>
              <tbody>
                <tr>
