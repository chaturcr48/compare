        ...
        <div className="row my-3 py-2">
          <div className="col-2">
            <button
              ...
              onClick={() => toggleTab(1)}
            >
              <img src={url.data[0]} className="small-img within" alt="..." />
            </button>
          </div>
          <div className="col-2">
            <button
              ...
              onClick={() => toggleTab(2)}
            >
              <img src={url.data[1]} className="small-img within" alt="..." />
            </button>
          </div>
          <div className="col-2">
            <button
              ...
              onClick={() => toggleTab(3)}
            >
              <img src={url.data[2]} className="small-img within" alt="..." />
            </button>
          </div>
          <div className="col-2">
            <button
              ...
              onClick={() => toggleTab(4)}
            >
              <img src={url.data[3]} className="small-img within" alt="..." />
            </button>
          </div>
        </div>
      </div>
